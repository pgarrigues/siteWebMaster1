...
<head>
	<meta charset="utf-8">
	<title>Établissements scolaires P1</title>
...
<body>
		...
		<div class="container">
			<div class="row">
				<div id="formulaire" class="col-md-4">
					<p> Trouvez toutes les écoles d'une commune :</p>
					<?php
					$selectionCommune = "SELECT DISTINCT commune FROM ecoles ORDER BY commune";
					$resultatSelectionCommune = mysqli_query($connexion, $selectionCommune);
					?>
					<form action="#" method="post">
						<select name="communeChoix">
					...
					if(isset($_POST['submit'])){
						$selected_val = $_POST['communeChoix'];
					...
					if(isset($selected_val)){
						$selectionEcoles = "SELECT ecoles.nom_officiel AS Nom, ecoles.adresse AS Adresse FROM ecoles WHERE ecoles.commune = '$selected_val' ORDER BY nom_officiel";
	...
	<script type="text/javascript">
		...
		var listeEcoles = <?php echo json_encode($listeEcoles); ?>;
